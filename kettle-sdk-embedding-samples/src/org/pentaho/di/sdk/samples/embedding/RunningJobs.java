...
/**
 * This class demonstrates how to load and execute a PDI job.
 * It covers loading from both file system and repositories, 
 * as well as setting parameters prior to execution, evaluating
 * the job result, and retrieving the job's log lines.
 */
public class RunningJobs {
	...
	public static void main(String[] args) {
		...
		Job job = instance.runJobFromFileSystem("etl/parametrized_job.kjb");
		...
		// repository and job exist, and can be accessed by the user and password used
		// uncomment and run after you've got a test repository in place

		// instance.runJobFromRepository("test-repository", "/home/joe", "parametrized_job", "joe", "password");
	 ...
	 * It demonstrates the following:
	 * 
	 * - Loading a job definition from a repository
	 * - Setting named parameters for the job
	 * - Setting the log level of the job
	 * - Executing the job, waiting for it to finish
	 * - Examining the result of the job
