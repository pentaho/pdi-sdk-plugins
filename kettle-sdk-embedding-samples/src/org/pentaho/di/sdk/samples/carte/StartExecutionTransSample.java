...
public class StartExecutionTransSample {
  public static void main( String[] args ) throws Exception {
    ...
    String port = args[1];
    String urlString = "http://" + realHostname + ":" + port + StartExecutionTransServlet.CONTEXT_PATH + "/?"
        + "xml=Y&name=" + args[4];
    ...
    sendStartExecutionTransRequest( urlString, auth );
  }

  public static void sendStartExecutionTransRequest( String urlString, String authentication ) throws Exception {
