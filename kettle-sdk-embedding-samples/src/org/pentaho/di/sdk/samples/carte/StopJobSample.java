...
public class StopJobSample {
  public static void main( String[] args ) throws Exception {
    ...
    String port = args[1];
    String urlString = "http://" + realHostname + ":" + port + StopJobServlet.CONTEXT_PATH + "/?"
        + "xml=Y&name=" + args[4];
    ...
    sendStopJobRequest( urlString, auth );
  }

  public static void sendStopJobRequest( String urlString, String authentication ) throws Exception {
