...
public class StartJobSample {
  public static void main( String[] args ) throws Exception {
    ...
    String port = args[1];
    String urlString = "http://" + realHostname + ":" + port + StartJobServlet.CONTEXT_PATH + "/?"
        + "xml=Y&name=" + args[4];
    ...
    sendStartJobRequest( urlString, auth );
  }

  public static void sendStartJobRequest( String urlString, String authentication ) throws Exception {
