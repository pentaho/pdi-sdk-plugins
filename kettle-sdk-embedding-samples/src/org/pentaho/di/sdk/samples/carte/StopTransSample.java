...
public class StopTransSample {
  public static void main( String[] args ) throws Exception {
    ...
    String port = args[1];
    String urlString = "http://" + realHostname + ":" + port + StopTransServlet.CONTEXT_PATH + "/?"
        + "xml=Y&name=" + args[4];
    ...
    sendStopTransRequest( urlString, auth );
  }

  public static void sendStopTransRequest( String urlString, String authentication ) throws Exception {
