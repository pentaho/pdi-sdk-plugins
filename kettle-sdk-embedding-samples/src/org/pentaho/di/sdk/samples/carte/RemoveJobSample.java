...
public class RemoveJobSample {
  public static void main( String[] args ) throws Exception {
    ...
    String port = args[1];
    String urlString = "http://" + realHostname + ":" + port + RemoveJobServlet.CONTEXT_PATH + "?xml=Y&name=" + args[4];
    ...
    sendRemoveJobRequest( urlString, auth );
  }

  public static void sendRemoveJobRequest( String urlString, String authentication ) throws Exception {
