...
public class RunTransSample {
  public static void main( String[] args ) throws Exception {
    ...
    String port = args[1];
    String transPath = URLEncoder.encode( args[4] );
    String urlString = "http://" + realHostname + ":" + port + RunTransServlet.CONTEXT_PATH
        + "?trans=" + transPath + "&level=" + args[5];
    ...
    sendRunTransRequest( urlString, auth );
  }

  public static void sendRunTransRequest( String urlString, String authentication ) throws Exception {
