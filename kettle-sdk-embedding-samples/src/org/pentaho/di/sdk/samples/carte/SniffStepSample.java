...
public class SniffStepSample {
  public static void main( String[] args ) throws Exception {
    ...
    String port = args[1];
    String urlString = "http://" + realHostname + ":" + port + SniffStepServlet.CONTEXT_PATH
        + "/?xml=Y&trans=" + args[4] + "&step=" + args[5];
    ...
    sendSniffStepRequest( urlString, auth );
  }

  public static void sendSniffStepRequest( String urlString, String authentication ) throws Exception {
