...
public class RemoveTransSample {
  public static void main( String[] args ) throws Exception {
    ...
    String port = args[1];
    String urlString = "http://" + realHostname + ":" + port + RemoveTransServlet.CONTEXT_PATH + "?xml=Y&name="
        + args[4];
    ...
    sendRemoveTransRequest( urlString, auth );
  }

  public static void sendRemoveTransRequest( String urlString, String authentication ) throws Exception {
