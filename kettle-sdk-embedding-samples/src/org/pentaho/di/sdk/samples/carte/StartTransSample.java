...
public class StartTransSample {
  public static void main( String[] args ) throws Exception {
    ...
    String port = args[1];
    String urlString = "http://" + realHostname + ":" + port + StartTransServlet.CONTEXT_PATH + "/?"
        + "xml=Y&name=" + args[4];
    ...
    sendStartTransRequest( urlString, auth );
  }

  public static void sendStartTransRequest( String urlString, String authentication ) throws Exception {
