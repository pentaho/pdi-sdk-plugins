...
/**
 * This defines an FtpPlus job entry.
 *
 * @author shepf
 * @since 12-18-2018
 *
...
public class JobEntryFtpPlus extends JobEntryBase implements Cloneable, JobEntryInterface {
    private static Class<?> PKG = JobEntryFtpPlus.class; // for i18n purposes, needed by Translator2!!
    ...
    public JobEntryFtpPlus( String n ) {
        super( n, "" );
        nr_limit = "10";
        port = "21";
        socksProxyPort = "1080";
    ...
    public JobEntryFtpPlus() {
        this( "" );
    }

    public Object clone() {
        org.pentaho.di.job.entries.ftp.JobEntryFTP je = (org.pentaho.di.job.entries.ftp.JobEntryFTP) super.clone();
        return je;
    }
    ...
    public Result execute(Result previousResult, int nr ) {
        ...
        if ( isDetailed() ) {
            logDetailed( BaseMessages.getString( PKG, "JobEntryFtpPlus.Start" ) );
        }
