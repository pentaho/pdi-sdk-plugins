...
public class RemoveJobSample extends AbstractSample {
  public static void main( String[] args ) throws Exception {
    ...
    String response = sendRemoveJobRequest( urlString, auth );
    if ( response != null ) {
  ...
  public static String sendRemoveJobRequest( String urlString, String authentication ) throws Exception {
    String message = "Error occurred during removing job.";
  ...
  public static String getUrlString( String realHostname, String port, String job_name ) {
    String urlString = "http://" + realHostname + ":" + port
      + RemoveJobServlet.CONTEXT_PATH + "/?xml=Y&name=" + job_name;
