...
public class PrepareExecutionTransSample extends AbstractSample {
  public static void main( String[] args ) throws Exception {
    ...
    String response = sendPrepareExecutionTransRequest( urlString, auth );
    if ( response != null ) {
  ...
  public static String getUrlString( String realHostname, String port, String jobName ) {
    String url = "http://" + realHostname + ":" + port + PrepareExecutionTransServlet.CONTEXT_PATH
      + "?xml=Y&name=" + jobName;
