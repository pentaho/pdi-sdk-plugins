...
public class StartExecutionTransSample extends AbstractSample {
  public static void main( String[] args ) throws Exception {
    ...
    String response = sendStartExecutionTransRequest( urlString, auth );
    if ( response != null ) {
  ...
  public static String getUrlString( String realHostname, String port, String transName ) {
    String url = "http://" + realHostname + ":" + port + StartExecutionTransServlet.CONTEXT_PATH
      + "/?xml=Y&name=" + transName;
