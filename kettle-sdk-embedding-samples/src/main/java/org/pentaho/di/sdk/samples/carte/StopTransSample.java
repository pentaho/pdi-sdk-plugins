...
public class StopTransSample extends AbstractSample {
  public static void main( String[] args ) throws Exception {
    ...
    String response = sendStopTransRequest( urlString, auth );
    if ( response != null ) {
  ...
  public static String getUrlString( String realHostname, String port, String transName ) {
    String url = "http://" + realHostname + ":" + port + StopTransServlet.CONTEXT_PATH
