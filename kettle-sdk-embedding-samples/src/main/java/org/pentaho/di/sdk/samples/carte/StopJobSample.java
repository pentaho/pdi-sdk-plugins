...
public class StopJobSample extends AbstractSample {
  public static void main( String[] args ) throws Exception {
    ...
    String response = sendStopJobRequest( urlString, auth );
    if ( response != null ) {
  ...
  public static String getUrlString( String realHostname, String port, String jobName ) {
    String url = "http://" + realHostname + ":" + port + StopJobServlet.CONTEXT_PATH
      + "/?xml=Y&name=" + jobName;
