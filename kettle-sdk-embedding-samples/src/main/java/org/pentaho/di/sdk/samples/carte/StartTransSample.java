...
public class StartTransSample extends AbstractSample {
  public static void main( String[] args ) throws Exception {
    ...
    String response = sendStartTransRequest( urlString, auth );
    if ( response != null ) {
  ...
  public static String getUrlString( String realHostname, String port, String transName ) {
    String url = "http://" + realHostname + ":" + port + StartTransServlet.CONTEXT_PATH
