...
public class PauseTransSample extends AbstractSample {
  ...
  public static void main( String[] args ) throws Exception {
    ...
    String response = sendPauseTransRequest( urlString, auth );
    if ( response != null ) {
  ...
  public static String getUrlString( String realHostname, String port, String transName ) {
    String url = "http://" + realHostname + ":" + port + PauseTransServlet.CONTEXT_PATH
